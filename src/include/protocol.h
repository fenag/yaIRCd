...
/** Define the string format specifier for printf for numreply_t */
#define NUMREPLY_T_FORMAT "%u"

/** Used to indicate the nickname parameter supplied to a command is currently unused. */
#define ERR_NOSUCHNICK 401U

/** Used to indicate the server name given currently doesn't exist. */
#define ERR_NOSUCHSERVER 402U

/** Used to indicate the given channel name is invalid. */
#define ERR_NOSUCHCHANNEL 403U
...
#define ERR_CANNOTSENDTOCHAN 404U

/** Sent to a user when they have joined the maximum number of allowed channels and they try to join another channel. */
#define ERR_TOOMANYCHANNELS 405U
...
#define ERR_WILDTOPLEVEL 414U

/** Returned to a registered client to indicate that the command sent is unknown by the server. */
#define ERR_UNKNOWNCOMMAND 421U

/** Server's MOTD file could not be opened by the server. */
#define ERR_NOMOTD 422U

/** Returned by a server in response to an ADMIN message when there is an error in finding the appropriate information. */
#define ERR_NOADMININFO 423U

/** Generic error message used to report a failed file operation during the processing of a message. */
#define ERR_FILEERROR 424U

/** Returned when a nickname parameter expected for a command and isn't found. */
#define ERR_NONICKNAMEGIVEN 431U
...
#define ERR_ERRONEUSNICKNAME 432U

/** Returned when a NICK message is processed that results in an attempt to change to a currently existing nickname. */
#define ERR_NICKNAMEINUSE 433U

/** Returned by a server to a client when it detects a nickname collision (registered of a NICK that already exists by another server). */
#define ERR_NICKCOLLISION 436U

/** Returned by the server to indicate that the target user of the command is not on the given channel. */
#define ERR_USERNOTINCHANNEL 441U
...
#define ERR_NOOPERHOST 491U

/** Returned by the server to indicate that a MODE message was sent with a nickname parameter and that the a mode flag sent was not recognized. */
#define ERR_UMODEUNKNOWNFLAG 501U

/** Error sent to any user trying to view or change the user mode for a user other than themselves.  */
#define ERR_USERSDONTMATCH 502U
/* End error replies */
