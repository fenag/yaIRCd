...
/** @file
	...
	Every function in this file is thread safe, with the exception of `client_list_init()` and `client_list_destroy()`, which shall be called exactly once by the parent thread before any thread is created and
